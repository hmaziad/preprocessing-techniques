...
# printRandomSample(getHistoryPercentage(parseDialogueFromFile(srcDialoguesPath),75))
# printRandomSample(getHistoryPercentage(getKBIntegrateDialogueUserRequest(parseDialogueFromFile(srcDialoguesPath),1), 75))
printRandomSample(getHistoryPercentageWithKeepOnlyDuplicates(parseDialogueFromFile(srcDialoguesPath),75))
